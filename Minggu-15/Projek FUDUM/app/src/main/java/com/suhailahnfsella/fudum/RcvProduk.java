...
public class RcvProduk {
    ...
    public RcvProduk(String tvJudulProduk, String tvKategoriProduk, String tvHargaProduk, String tvKecProduk, String tvKabProduk, Integer imgProduk1) {
